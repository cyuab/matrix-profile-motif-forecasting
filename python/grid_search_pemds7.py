...
def run_grid_search():
    ...
    param_no_points_after_motif = [1, 5, 9]

    # param_include_covariates = [True, False]
    # param_include_motif_information = [0]
    # param_k_motifs = [1]
    # param_no_points_after_motif = [1]
    
    include_itself = True
    num_periods_output = 9
    num_periods_input = 9
    ...
    output_file = "../results/grid_search_pemds7_results.csv"
